...
export class MissionService {
  ...
  create(m: Partial<Mission>): Observable<Mission> {
    return this.http.post<Mission>(this.baseUrl, m);
  }
  update(id: string, m: Partial<Mission>): Observable<void> {
    return this.http.put<void>(this.baseUrl, { ...m, id });
  }
